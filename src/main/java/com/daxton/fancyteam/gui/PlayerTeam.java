...
public class PlayerTeam {
	...
	public static void teamPlayers(GUI gui, Player player, FTeam team){
		...
		gui.setItem(GuiButtom.valueOf(languageConfig,"Language.Gui.SettingTeam.TeamChat."+teamChat), false,1, 1);
		...
		//離開隊伍
		gui.setItem(GuiButtom.valueOf(languageConfig,"Language.Gui.Main.LeaveTeam"), false,1, 6);
